...
public class T2ringuPokker {
	...
	public static void main(String[] args) {
		int user_money = 100;
		while (user_money > 0) {
			System.out.printf("Sul on hetkel %d eurot%n", user_money);
			...
			if (taring == vastus) {
				user_money += panus*6;
				System.out.printf("Sa *võitsid* endale %d eurot%n", panus*6);
			} else {
				user_money -= panus;
				System.out.printf("Täringule tuli %d, sa *kaotasid* %d eurot%n", taring, panus);
			}
		}
